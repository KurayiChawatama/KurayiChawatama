...
- 🎯 **Experience and Projects:**
  ...
  - **EU-Funded SUSA Internship Program**: Accepted to the [SUSA internship program](https://ec.europa.eu/info/funding-tenders/opportunities/portal/screen/opportunities/competitive-calls-cs/11143) within an EU-funded project in [Asst. Prof. Burçak Otlu](https://scholar.google.com/citations?user=KWXbqQ8AAAAJ&hl=en)'s lab at Middle East Technical University. Over the next month, I will help develop reproducible Nextflow pipelines for cancer genomics analyses using the lab's [SigProfiler](https://cancer.sanger.ac.uk/signatures/tools/) suite of tools  for mutational signature extraction, assignment, and topography analysis within digital health research workflows.
   - **Open Source Nextflow Pipeline Development**: Contributor and core team member of [nf-core/scdownstream](https://nf-co.re/scdownstream/dev/), enhancing scRNA-seq analysis by developing new doublet detection modules (scDblFinder) and multispecies cell type annotation support. Fixed runtime errors during the March 2025 Hackathon and contributed documentation, including a [blog post](https://nf-co.re/blog/2025/nf-core-colab-guide) and [tutorial guide](https://nf-co.re/docs/tutorials/google_colab/nf-core_colab_guide) on running nf-core pipelines in Google Colab as part of the [outreach team](https://nf-co.re/governance#outreach). (See pinned repos)
