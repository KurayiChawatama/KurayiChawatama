...
- 🎯 **Experience and Projects:**
  ...
  - **Open Source Nextflow Pipeline Development**: I am working on enhancing the [nf-core/scdownstream](https://nf-co.re/scdownstream/dev/) pipeline to improve it's scRNAseq analysis by developing better doublet detection (scDblFinder) and multispecies cell type annotation support, working toward integrating them into the main pipeline since the March 2025 Hackathon.(See pinned Repos)
